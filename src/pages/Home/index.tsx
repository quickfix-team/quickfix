    ...
    return (
        <StyledDiv>
            <main>
                ...
                />
                <p>
                    Não fique preocupado, o seu problema tem solução, oferecemos o melhor serviço
                    tecnico de celular do brasil e com um orçamento que cabe no seu bolso.
                </p>
                <Link to={'/dashboard'}>
                    <ContainerPattern>
                        <span>
                            Procure empresas proximas a sua localização e faça já o seu orçamento!
                        </span>
                        <img
